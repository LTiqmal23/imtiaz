                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>" . $row["clerkID"] . "</td>";
                                echo "<td>" . $row["clerkName"] . "</td>";
                                echo "<td>" . $row["clerkPhone"] . "</td>";
                                echo "<td>" . $row["clerkEmail"] . "</td>";
                                echo "<td>";
                                echo "<a href='#' class='view ' data-id='" . $row["clerkID"] . "'><i class='fas fa-eye'></i></a>";
                                echo "<a href='#' class='edit ms-2' data-id='" . $row["clerkID"] . "'><i class='fas fa-edit'></i></a>";
                                echo "<a href='#' class='delete ms-2' data-id='" . $row["clerkID"] . "'><i class='fas fa-trash'></i></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        } else {
            ...
            <div class="modal-body">
                <form action="process/add_clerk.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="clerkEmail" name="clerkEmail" required>
                    </div>
                    <div class="mb-3">
                        <label for="clerkPassword" class="form-label">Password</label>
                        <input type="text" class="form-control" id="clerkPassword" name="clerkPassword" required>
                    </div>
