        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="process/add_student.php" method="POST">
                    <div class="mb-3">
                        <label for="studIC" class="form-label">IC</label>
                        <input type="text" class="form-control" id="studIC" name="studIC" required>
                    </div>
                    <div class="mb-3">
                        <label for="studEmail" class="form-label">Email</label>
                        <input type="text" class="form-control" id="studEmail" name="studEmail" required>
                    </div>
                    <div class="mb-3">
                        <label for="studPassword" class="form-label">Password</label>
                        <input type="text" class="form-control" id="studPassword" name="studPassword" required>
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-body">
                <form action="process/edit_student.php" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="hidden" class="form-control" id="editStudID" name="studID">
                    </div>
                    <div class="mb-3">
